...
@section('content')
    ...
    <tr>
        <td data-th="Product">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <h4 class="nomargin"><a href="/catalog/product/{{$item->id}}">{{$item->name}}</a> </h4>
                    <p>
    ...
    <tr>
        ...
        <td><a href="/catalog/check_out" class="btn btn-success btn-block">Checkout <i class="fa fa-angle-right"></i></a></td>
    </tr>
    </tfoot>
</table>
</div>
